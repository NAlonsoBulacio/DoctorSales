...
const Header = () => {
  return (
    <div className="header w-full flex items-center justify-center relative">
        ...
        <div className="w-full h-full overflow-hidden">
          <div className="">
            ...
            <img
              src={banner}
              alt=""
              className="fixed-image w-full h-full object-cover"
            />
          </div>
          ...
          <div className="flex justify-center items-center absolute top-44 translate-x-0">
            <div className="w-2/3 space-y-12">
              ...
              <div className="flex justify-center items-center space-x-4">
                <h1 className="w-1/2 font-noto-300 text-white text-xl">
