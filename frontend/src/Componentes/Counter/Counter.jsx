    ...
    <div className="w-full flex justify-center items-center">
      <div className="flex flex-wrap justify-center items-center px-10">
        <div className="w-full md:w-1/3 flex flex-wrap justify-center items-center">
          <div ref={ref1} className="w-full flex justify-center md:justify-start items-center">
            <p className="text-purple-800 font-noto-600 w-40 text-5xl md:text-6xl">
              ${count1}K
            </p>
          </div>
        ...
        <div className="w-full md:w-1/3 flex flex-wrap justify-center items-center">
          <div ref={ref2} className="w-full flex justify-center md:justify-start items-center">
            <p className="text-purple-800 font-noto-600 w-40 text-5xl md:text-6xl">
