    ...
    <div className="w-full h-auto flex justify-center items-start ">
      <div className="space-y-4">
        ...
        <div className="flex justify-center items-center">
          ...
          <button
            className="ov-btn-slide-left font-inter-600 max-w-[700px] bg-gradient-to-r from-yellow-800 to-yellow-900 text-white text-2xl py-2 px-4 rounded-xl mb-2 mx-8 md:mx-4 "
            style={{
              marginBottom: "3rem",
              display: "flex",
