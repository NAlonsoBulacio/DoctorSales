  ...
  return (
    <div className="flex justify-center items-center">
      <div className="relative w-full md:h-[420px] md:w-[740px] overflow-hidden">
        ...
        {!playing && (
          <>
          <img src={frame} alt="frame-video" onClick={togglePlay} className={`relative inset-0 w-full h-full object-cover object-center opacity-transition ${playing ? 'opacity-0' : 'opacity-100'}`}/>
