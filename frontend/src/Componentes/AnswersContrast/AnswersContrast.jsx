...
const AnswersContrast = () => {
  return (
    <div className="w-full relative flex justify-center items-center py-0 md:py-12">
    <div className="w-full md:w-4/5 px-8 md:px-14 py-4  border-white border-2 rounded-xl flex justify-center items-center">
      <div className="space-y-6">
        <h1 className="w-full md:w-4/5 text-4xl md:text-5xl text-left mb-8 font-noto-600">
          Ahora, déjame hacerte una pregunta: <br />
          <span className="text-purple-800">
            ¿Qué te impide vender más?
          </span>
        </h1>
        <h1 className="w-4/5 text-2xl md:text-3xl text-left mb-8 font-noto-500 text-gray-700">
        ...
        <div className="flex justify-start items-start space-x-4 text-left ">
          <div
            className="flex items-center pt-1 w-[24px] md:w-[35px] h-[24px] md:h-[35px]"
            >
