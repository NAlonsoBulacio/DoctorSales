...
`,
      name: "Pedro Suarez",
      positionCompany: "CEO de Shell Brothers Company",
...
`,
  ...
  return (
    <div className="w-full flex flex-wrap justify-center items-center px-20 gap-x-20">
      {reviews?.map((review, index) => (
        <div key={index} className="w-1/3 flex flex-wrap justify-center items-center">
